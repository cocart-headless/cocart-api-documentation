...
<CardGroup cols={2}>
  ...
  <Card title="JWT Token Checkup" icon="key" href="/authentication/jwt/token-management">
...
<CardGroup cols={2}>
  ...
  <Card title="Extending the Products API" icon="tags" href="/tutorials/extending-products-api">
    Add custom fields to product responses using PHP filters
  </Card>
</CardGroup>
...
- Join our [Community](/community) to ask questions and share knowledge

## Contributing

Have a tutorial idea or found an issue? We welcome contributions! Check out our [Contributing to Documentation](/contributing-to-docs) guide to learn how you can help improve our documentation.
