...
### CoCart Starter (latest, v5.0.0)

| Specification File | Covers |
|-------------------|--------|
| `basic/v2/openapi-cocart-v2-collection.yaml` | **All v2 endpoints combined** — cart, products, sessions, store, login/logout |
| `basic/v2/openapi-cocart-cart-v2.yaml` | Cart endpoints only |
| `basic/v2/openapi-cocart-products-v2.yaml` | Products endpoints only |
| `basic/v2/openapi-cocart-sessions-v2.yaml` | Sessions endpoints only |
| `basic/v2/openapi-cocart-others-v2.yaml` | Login, logout, and store endpoints |

### CoCart Community (v4.9.0)

| Specification File | Covers |
|-------------------|--------|
| `community/v2/openapi-cocart-v2-stable.yaml` | All community v2 endpoints combined |
...
| `plus/v1/openapi-cocart-plus-v1-collection.yaml` | CoCart Plus v1 — coupons, fees, shipping, and granular totals |
...
```json
{
  "scripts": {
    ...
    "generate-types:all": "npm run generate-types:v2 && npm run generate-types:jwt"
  }
}
```
