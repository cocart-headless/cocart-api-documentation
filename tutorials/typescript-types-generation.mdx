...
<Note>
  This tutorial focuses on **CoCart Starter v2** (the collection spec), which is recommended for all new projects. The same approach works with any of the specs above.
</Note>
...
```bash
npx openapi-typescript https://raw.githubusercontent.com/cocart-headless/cocart-openapi/main/basic/v2/openapi-cocart-v2-collection.yaml -o src/types/cocart.ts
```
...
{
  "scripts": {
    "generate-types": "openapi-typescript https://raw.githubusercontent.com/cocart-headless/cocart-openapi/main/basic/v2/openapi-cocart-v2-collection.yaml -o src/types/cocart.ts"
  }
}
```
...
```bash
curl -o openapi-cocart-v2.yaml https://raw.githubusercontent.com/cocart-headless/cocart-openapi/main/basic/v2/openapi-cocart-v2-collection.yaml
```
...
npx openapi-typescript https://raw.githubusercontent.com/cocart-headless/cocart-openapi/main/basic/v2/openapi-cocart-v2-collection.yaml \
...
{
  "scripts": {
    "generate-types:v2": "openapi-typescript https://raw.githubusercontent.com/cocart-headless/cocart-openapi/main/basic/v2/openapi-cocart-v2-collection.yaml -o src/types/cocart-v2.ts",
