...
<Note>
    If you have CoCart Community installed, this guide only works if you v4.8 and up installed.
</Note>
...
add_filter( 'cocart_login_query_parameters', function( $additional_params ) {
