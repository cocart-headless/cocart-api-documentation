...
<CardGroup cols={2}>
  <Card title="Stripe Checkout" icon="stripe" href="/tutorials/pre-release/checkout-stripe">
    Complete Stripe Elements integration with Payment Intents API
  </Card>

  <Card title="PayPal Checkout" icon="paypal" href="/tutorials/pre-release/checkout-paypal">
    PayPal Buttons integration with order capture flow
  </Card>

  {/* Restore this card once the Square tutorial exists
  <Card title="Square Checkout" icon="square" href="/tutorials/pre-release/checkout-square">
    Square Web SDK integration with payment forms
  </Card>
  */}

  <Card title="General Payment Processing" icon="credit-card" href="/tutorials/pre-release/checkout-payment-processing">
