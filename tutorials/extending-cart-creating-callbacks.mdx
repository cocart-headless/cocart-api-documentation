...
<Note>
  This comprehensive guide covers both **CoCart Community** and **CoCart Starter** callback systems. Choose the version that matches your CoCart installation.
</Note>
...
<Tabs>
  <Tab title="CoCart Community">
    ...
    <?php
    /**
     * Loyalty Points Callback for CoCart Community
     */
    if ( ! defined( 'ABSPATH' ) ) {
        exit;
    }
  ...
  <Tab title="CoCart Starter">
    ...
    <?php
    /**
     * Loyalty Points Callback for CoCart Starter
     */
    if ( ! defined( 'ABSPATH' ) ) {
        exit;
    }
...
<Tabs>
  ...
  <Tab title="CoCart Starter">
    ...
    if ( $cart_updated ) {
        // uses controller method directly
...
<Warning>
  If you registered a callback before with version 4 or lower of CoCart Community, you will need to register them again for CoCart Starter. We simplified the callback system to perform better in CoCart Starter.
</Warning>
...
### Migration from CoCart Community to CoCart Starter
...
## CoCart Starter Performance Improvements
...
<Warning>
  CoCart Starter callbacks are **not** backward compatible with CoCart Community. You must update your registration code when upgrading.
</Warning>
...
<Tabs>
  ...
  <Tab title="CoCart Starter">
    ...
    - **Mixed versions**: Don't use both registration methods
  </Tab>
</Tabs>
...
| Feature | CoCart Community | CoCart Starter |
|---------|-------------------|---------------------------|
