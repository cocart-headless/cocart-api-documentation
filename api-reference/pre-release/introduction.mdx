...
Using **raw** works best if you are passing an object of data for a `variation` or `cart_item_data`. Use [any of the tools available](/tools) to help test the API with if you are unsure.
