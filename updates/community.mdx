...
<Update label="June 15, 2026" description="v4.9.0">
...
In your WordPress Dashboard, we added an integrations page that lets you control which supported plugins are active during CoCart requests.
...
<Danger>
  ...
  * Slugs and permalinks containing non-ASCII characters (such as Chinese or Arabic) are now returned decoded instead of URL-encoded.
