...
<AccordionGroup>
    ...
    <Accordion title="Can I translate CoCart?">
        ...
        If the language you’d like to translate the plugin into isn’t available yet, please [ask via email](mailto:support@cocartapi.com?Subject=Requesting Translation Set) to let us know which one so I can create that translation set.
    </Accordion>
    ...
    <Accordion title="My question is not listed here. Where can I find more?">
        We have more available in our [support center](/knowledge-base/introduction).
    </Accordion>
</AccordionGroup>
