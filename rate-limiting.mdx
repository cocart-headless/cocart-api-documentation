...
description: "Protect your WooCommerce store from API abuse with CoCart Plus rate limiting — set request limits per user or IP, configure proxy support, and track violations."
"og:title": "API Rate Limiting for CoCart — Prevent Abuse & Control Traffic"
icon: "gauge-high"
tag: "Updated"
---
...
<Info>
    This method is available in CoCart Plus v1.6.0 and later.
</Info>
