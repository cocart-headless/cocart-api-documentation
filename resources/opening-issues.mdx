...
We ask that **issues are only opened for bugs**, and not for questions. Questions should be asked in [Discussions](https://github.com/co-cart/co-cart/discussions) or on Discord.
