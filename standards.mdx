...
5. All API responses will contain the version of CoCart Community via the returned header `CoCart-Version` if you have `WP_DEBUG` enabled which will be set to the current version of the plugin you are using.
