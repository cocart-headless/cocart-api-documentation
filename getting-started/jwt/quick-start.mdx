...
<Info>
    This guide assumes you have already installed and configured CoCart JWT Authentication. If not, make sure you have downloaded the [JWT Authentication for CoCart](https://wordpress.org/plugins/cocart-jwt-authentication/) plugin and installed it.
</Info>
