---
title: "Swift SDK: Error Handling"
sidebarTitle: "Error Handling"
description: "Error types, catching errors, and HTTP status code mapping in the CoCart Swift SDK."
'og:title': "Error Handling — CoCart Swift SDK"
'og:description': "The CoCartError enum, do/catch patterns, JWT expiry handling, client-side validation errors, and HTTP status code mapping in the CoCart Swift SDK."
---
...
See [Authentication](/sdk/swift/authentication#auto-refresh) for details.
