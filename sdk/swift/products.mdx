---
title: "Swift SDK: Products API"
sidebarTitle: "Products API"
description: "Browse, filter, and search the WooCommerce product catalog with the CoCart Swift SDK."
'og:title': "Products API — CoCart Swift SDK"
'og:description': "Browse, filter, paginate, and search WooCommerce products from Swift. Categories, tags, attributes, variations, and reviews — no authentication required."
---
...
`get()` accepts either the numeric product/variation ID or the product's SKU — either one works:
