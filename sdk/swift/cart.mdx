---
title: "Swift SDK: Cart API"
sidebarTitle: "Cart API"
description: "Manage shopping carts with the CoCart Swift SDK — add, update, remove items, coupons, customer details, shipping, fees, and ETag caching."
'og:title': "Headless WooCommerce Cart API — CoCart Swift SDK"
'og:description': "Manage WooCommerce carts from Swift. async/await throughout, client-side validation before network calls, add/update/remove items, coupons, shipping, fees, and ETag caching."
---
...
See [Error Handling](/sdk/swift/error-handling) for handling API errors.
