---
title: "Swift SDK: Sessions API"
sidebarTitle: "Sessions API"
description: "Manage cart sessions and storage adapters with the CoCart Swift SDK — admin sessions endpoint, Keychain storage, and guest session lifecycle."
'og:title': "Sessions API — CoCart Swift SDK"
'og:description': "Admin sessions endpoint for managing active carts server-side, Keychain and in-memory storage adapters, and the full guest-to-customer cart transfer flow."
---
...
The Sessions endpoint is for administrators to manage cart sessions server-side. It requires WooCommerce REST API credentials (see [Consumer Keys](/sdk/swift/authentication#consumer-keys-admin)).
...
See [Authentication](/sdk/swift/authentication) for more on JWT and Basic Auth setup.
