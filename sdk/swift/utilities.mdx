---
title: "Swift SDK: Utilities"
sidebarTitle: "Utilities"
description: "Currency formatting, event system, and secure session storage in the CoCart Swift SDK."
'og:title': "Utilities — CoCart Swift SDK"
'og:description': "Standalone helpers in the CoCart Swift SDK — the CurrencyFormatter for smallest-unit prices, a request/response event system, and Keychain-backed session storage."
---
...
See [Sessions & Storage](/sdk/swift/sessions#storage-adapters) for details on custom storage adapters.
