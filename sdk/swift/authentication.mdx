---
title: "Swift SDK: Authentication"
sidebarTitle: "Authentication"
description: "Guest sessions, Basic Auth, JWT, and consumer keys with the CoCart Swift SDK."
'og:title': "Authentication — CoCart Swift SDK"
'og:description': "Authenticate with the CoCart REST API from Swift — guest sessions with Keychain-backed cart keys, Basic Auth, JWT with auto-refresh, and consumer keys for admin access."
---
