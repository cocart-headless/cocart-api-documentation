---
title: "React Native SDK: Products API"
sidebarTitle: "Products API"
description: "Browse, filter, search, and paginate your store's product catalog with the CoCart React Native SDK — no authentication required."
'og:title': "Products API — CoCart React Native SDK"
'og:description': "Browse the WooCommerce catalog from React Native using useProducts — filtering, search, variations, categories, tags, and pagination."
---
...
```tsx
import { useProducts } from '@cocartheadless/react-native-sdk';
...
<Note>`category` takes priority over `tag`, and both take priority over `filters`.</Note>
...
import { useProducts, useCartMutations } from '@cocartheadless/react-native-sdk';
...
See [Error Handling](/sdk/react-native/error-handling) for handling API errors.
