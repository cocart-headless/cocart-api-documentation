---
title: "React Native SDK: Error Handling"
sidebarTitle: "Error Handling"
description: "Error hierarchy, catching errors, hook error state, and HTTP status code mapping for the CoCart React Native SDK."
'og:title': "Error Handling — CoCart React Native SDK"
'og:description': "Catch and handle CoCart React Native SDK errors — the CoCartError hierarchy, 2FA flow, client-side validation, legacy plugin guards, and JWT expiry."
---
...
import {
  ...
  ValidationError,
  VersionError,
} from '@cocartheadless/react-native-sdk';
...
```tsx
import { TwoFactorAuthRequiredError, AuthenticationError } from '@cocartheadless/react-native-sdk';
...
See [Authentication](/sdk/react-native/authentication#two-factor-authentication) for the full flow.
...
```tsx
import { VersionError } from '@cocartheadless/react-native-sdk';
