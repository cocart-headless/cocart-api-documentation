---
title: "React Native SDK: Authentication"
sidebarTitle: "Authentication"
description: "Guest sessions, Basic Auth, JWT authentication with auto-refresh, Two Factor Authentication, and consumer keys with the CoCart React Native SDK."
'og:title': "Authentication — CoCart React Native SDK"
'og:description': "Authenticate guests, customers, and admins with the CoCart React Native SDK — guest sessions, Basic Auth, JWT with auto-refresh, 2FA, and consumer keys."
---
...
```tsx
import { CoCartProvider, MMKVStorage, useCart } from '@cocartheadless/react-native-sdk';
...
```tsx
import { CoCart, JwtManager, MMKVStorage } from '@cocartheadless/react-native-sdk';
