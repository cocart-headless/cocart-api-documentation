---
title: "PHP SDK: Error Handling"
sidebarTitle: "Error Handling"
description: "Handle errors from the CoCart PHP SDK — exception hierarchy, catching exceptions, JWT token expiry, and HTTP status code mapping."
'og:title': "Error Handling in the CoCart PHP SDK"
'og:description': "Handle CoCart REST API errors in PHP. Exception hierarchy, catch by class, detect expired JWT tokens, extract field-level validation errors, and map HTTP status codes."
---
...
See [Authentication](/sdk/php/authentication#auto-refresh) for details.
...
The `Response` object implements `ArrayAccess`:
