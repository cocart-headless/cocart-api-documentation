---
title: "Python SDK: Products API"
sidebarTitle: "Products API"
description: "Browse your WooCommerce catalog with the CoCart Python SDK — list, filter, search, paginate products, variations, categories, attributes, brands, and reviews."
'og:title': "WooCommerce Products API — CoCart Python SDK"
'og:description': "Query the WooCommerce product catalog from Python. Filter by category, price, and stock; search; iterate pages with Python's iterator protocol; fetch variations, attributes, and brands."
---
...
<Note>Requires the [CoCart SEO Pack](https://cocartapi.com) plugin.</Note>
