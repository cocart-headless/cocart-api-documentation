---
title: "Flutter SDK: Error Handling"
sidebarTitle: "Error Handling"
description: "Error types, validation errors, and HTTP status code mapping in the CoCart Flutter SDK."
'og:title': "Error Handling — CoCart Flutter SDK"
'og:description': "Handle CoCart API errors in Flutter with typed exceptions — validation, authentication, rate limiting, network failures, and legacy version guards."
---
