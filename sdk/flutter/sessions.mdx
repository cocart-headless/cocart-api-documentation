---
title: "Flutter SDK: Sessions API"
sidebarTitle: "Sessions API"
description: "Admin sessions endpoint, storage adapters, and the guest-to-customer flow with the CoCart Flutter SDK."
'og:title': "Sessions API & Storage Adapters — CoCart Flutter SDK"
'og:description': "Admin-level Sessions API access, storage adapters for persisting cart keys and JWT tokens, and the guest-to-customer login flow in Flutter."
---
...
See [Authentication](/sdk/flutter/authentication) for the full authentication guide.
