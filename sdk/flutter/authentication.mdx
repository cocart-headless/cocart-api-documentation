---
title: "Flutter SDK: Authentication"
sidebarTitle: "Authentication"
description: "Authenticate with CoCart using the Flutter SDK — guest sessions, Basic Auth, JWT, consumer keys, and custom auth headers."
'og:title': "Authentication with the CoCart Flutter SDK"
'og:description': "Authenticate headless WooCommerce from Flutter. Guest cart sessions, Basic Auth, JWT login with auto-refresh, consumer keys for admin, and custom auth header names."
---
...
More secure than Basic Auth. Requires the [CoCart JWT Authentication](https://wordpress.org/plugins/cocart-jwt-authentication/) plugin.
...
See [Error Handling](/sdk/flutter/error-handling) for handling authentication failures.
