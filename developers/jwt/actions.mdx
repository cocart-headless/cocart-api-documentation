---
title: "JWT Authentication Action Hooks"
sidebarTitle: "JWT Auth Actions"
description: "Action hooks for the CoCart JWT Authentication plugin. Fire custom code when tokens are generated, refreshed, validated, deleted, or when a user authenticates via JWT."
---
