---
title: "JWT Authentication Filters"
sidebarTitle: "JWT Auth Filters"
description: "PHP filter hooks for the CoCart JWT Authentication plugin. Customize token issuance, expiration, algorithms, refresh tokens, and revocation policies."
---
...
<Tip>
    See the [Developer Reference](/developers) for the full plugin key index. All hooks on this page apply to the <Badge color="green">JWT</Badge> add-on.
</Tip>
...
<Note>It is **NOT required** to use a prefix, but it can help to distinguish tokens from different sources or implementations so use a unique prefix.</Note>
