...
<Warning>
This replaces the `cocart_products_ignore_private_meta_keys` filter from the Community edition, which is [no longer used in Basic](/breaking-changes/basic-v5).
</Warning>
